...
*Version 4.7, 2026-04-30 – ersätter version 4.6*
...
> **Ämne:** Revisionsunderlag 2025 – Verifikationslista från [bokföringssystem]
>
> Hej!
>
> Som revisor behöver jag ett utdrag ur [bokföringssystem] för räkenskapsåret 2025. Det kallas *verifikationslista* eller *grundbok* – en lista på alla bokförda händelser under 2025 med verifikationsnummer, serie, datum, belopp och konto.
>
> De flesta bokföringssystem har en funktion för detta under något av följande alternativ:
> - **Fortnox:** Gå till *Bokföring* → *Rapporter* → *Verifikationslista* (eller *Grundbok*). Välj räkenskapsåret och perioden 2025-01-01–2025-12-31, välj alla serier, och exportera som Excel eller PDF.
> - **Visma eEkonomi:** Gå till *Rapporter* → *Grundbok* (eller *Verifikationslista* beroende på version). Sätt perioden till 2025-01-01–2025-12-31 och välj alla serier. Klicka *Exportera* och välj Excel.
> - **Bokio eller annat system:** Funktionen finns vanligtvis under Rapporter eller Bokföring – sök på "verifikation" eller "grundbok" i systemet.
>
> Behöver du hjälp att hitta funktionen är det lättast att vi gör det tillsammans – det tar bara några minuter.
>
> Tack!

**I bokföringssystemet – steg för steg (revisorns perspektiv):**

Nedan anges steg för de system som är vanligast förekommande. **Bekräfta alltid med ekonomiansvarig vilket system som används innan du ger instruktioner.**

*Fortnox (Kalmar Nation använder Fortnox):*
1. Be PQe logga in på Fortnox
2. Gå till **Bokföring** → **Rapporter** → **Verifikationslista** (eller sök på "verifikation" i systemet)
3. Välj räkenskapsår **2025** och perioden **2025-01-01 – 2025-12-31**, välj alla verifikationsserier
...
*Visma eEkonomi (generell referens, ej Kalmar Nation):*
...
**K1-rapport och K1-format:** K1 (BFNAR 2016:10, *Årsredovisning i mindre företag*) är ett förenklat regelverk för redovisning som gäller för mindre företag och organisationer i Sverige. I bokföringssystem som Fortnox och Visma eEkonomi används begreppet "K1-format" (eller ÅRL-format) för att beskriva hur resultatrapporten är strukturerad. Det är viktigt att känna till vad som ingår respektive inte ingår i detta format, eftersom det direkt påverkar hur man tolkar siffrorna.
...
I praktiken är deras bokföringssystem (Fortnox) konfigurerat med **ÅRL-strukturerade rapporter** (K2-format) och lagerförändrings- och nedskrivningskonton (4901–4909 och 7741–7749) används faktiskt i bokföringen – i linje med vad K2-bokslutet kräver.
...
*Denna instruktion är generell och ska alltid anpassas till den specifika organisation, det specifika räkenskapsår och den specifika person som granskas. Version 4.7, 2026-04-30.*
