...
Om du i stället öppnar **endast** mappen `KalmarNation/revision` som egen workspace-rot (utan förälderknappen ClaudeCowork) laddas inte de globala reglerna automatiskt. Rekommendation: öppna hela **ClaudeCowork** som workspace så gäller samma globala regler överallt.
